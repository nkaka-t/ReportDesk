...
Support
- If you hit issues during setup, copy the terminal output and open an issue in the repo or contact the maintainer him self you knnow the number dont pretend.
