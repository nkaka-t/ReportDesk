...
export default function App(){
  ...
  useEffect(()=>{
    const onAuthRole = () => setRole(localStorage.getItem('role'));
    window.addEventListener('authchange', onAuthRole);
    return () => window.removeEventListener('authchange', onAuthRole);
  },[]);
        ...
        <Toolbar>
          ...
          <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={()=>setAnchorEl(null)}>
            ...
            <MenuItem onClick={()=>{ setAnchorEl(null); navigate('/notifications'); }}>Notifications</MenuItem>
              {role === 'admin' && <MenuItem onClick={()=>{ setAnchorEl(null); navigate('/admin'); }}>Admin</MenuItem>}
